...
class HeightChoice extends StatefulWidget {

  Function(String name, String value) onSubmit;

  HeightChoice(this.onSubmit, {Key? key}) : super(key:key);

  @override
  State<HeightChoice> createState() => _HeightChoiceState();
}

class _HeightChoiceState extends State<HeightChoice> {

  var heigth = [for (var i = 150; i <= 210; i++) i];
  int _focusedIndex = 0;
  ...
  void NextPage() {
    widget.onSubmit('height', heigth[_focusedIndex].toString());
  }
    ...
    return Container(
      decoration: const BoxDecoration(
        image: DecorationImage(
          image: AssetImage("assets/images/registration/height.png"),
          fit: BoxFit.cover,
        ),
      ),
      child: Column(
